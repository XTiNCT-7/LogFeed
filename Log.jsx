...
const Log = () => {
    ...
    // const startLogApi = () => {
    //     return fetch('http://localhost:8080/api/logs/start')
    ...
    //   }
      ...
      const handleClick = () => {
        ...
        fetch('http://localhost:8080/api/logs/start')
          .then(response => response.json())
          .then(() => {
            // Call the second API to retrieve data
            ...
            <div className='mt-4'>
                ...
                <nav aria-label="Page navigation example">
                    ...
                    <ul className="pagination pagination-sm justify-content-end">
                        <li className='page-item' style={{marginRight : 570}}>
                        <button onClick={handleClick} type='button' className='btn btn-info'>Get Logs</button>
                        </li>
                ...
                <table className="table table-hover" >
                    <thead>
                        <tr className='bg-header text-white'>
                            <th className='col-3 ps-5'>Date | Timestamp</th>
                            <th className='col-2 text-center'>Log Type</th>
                            <th className='col-5 ps-5'>System Name</th>
                        </tr>
                    </thead>
                    <tbody>
