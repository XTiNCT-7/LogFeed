    ...
    <>
      <tr style={{ backgroundColor: "#F0F8FF" }} className="text-start">
        <td className="col-2 ps-3">
          ...
          <span className="ps-3">{data.timestamp}</span>
        </td>
        {/* <td className="col-2">{data.time}</td> */}
        <td className="col-2 text-center">
          <span
            style={{ borderRadius: "1rem" }}
            className={"fs-6  d-block p-1 "}
          >
            <span >{data.level}</span>
          </span>
        </td>
        <td className="col-2">{data.systemName}</td>
        <td className="col-6">
          <div className="row">
            <div className="col-7">
              <span className="fs-6">
        ...
        <td colSpan={4}>
          <div className="collapse" id={"ac" + index}>
            <div className="card card-body text-start">
              <p>
                <span className="fw-bold fs-6">Log: </span>
                {data.message}
              </p>
            </div>
          </div>
